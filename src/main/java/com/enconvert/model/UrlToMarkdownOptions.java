...
/** Options for {@code Enconvert#convertUrlToMarkdown}. */
public final class UrlToMarkdownOptions {
    ...
    private UrlToMarkdownOptions(Builder b) {
    ...
    public static final class Builder {
        ...
        public UrlToMarkdownOptions build() {
            return new UrlToMarkdownOptions(this);
        }
    }
}
