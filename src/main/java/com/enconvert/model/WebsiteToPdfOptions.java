...
/**
 * Options for {@code Enconvert#convertWebsiteToPdf}.
 *
 * <p>Unlike the single-URL options, render fields (viewport, loadMedia,
 * enableScroll) are only sent to the API when explicitly set here — the
 * gateway applies its own per-page defaults otherwise.
 */
public final class WebsiteToPdfOptions {
    ...
    private WebsiteToPdfOptions(Builder b) {
    ...
    public static final class Builder {
        ...
        public WebsiteToPdfOptions build() {
            return new WebsiteToPdfOptions(this);
        }
    }
}
